...
def add_stock(stock_list):
    ...
    while option != "0":
        ...
        option = input("Press to add another stock or 0 to end: ")
...
def list_stocks(stock_list):
    #output a suitable title for the Stock List screen
    print("Stock list")
